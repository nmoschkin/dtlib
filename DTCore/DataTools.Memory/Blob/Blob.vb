...
#Region "FileSystem Declarations"
        ...
        Declare Function GetFileSize Lib "kernel32" Alias "GetFileSize" (ByVal hFile As IntPtr, ByRef lpFileSizeHigh As UInteger) As UInteger
...
#Region "Parse and ToString"
        ...
        Public Overloads Function ToString(ByVal plainNum As Boolean) As String
...
#Region "Copying"
        ...
        Public Overloads Sub CopyTo(destinationArray() As Byte, Optional ByVal startIndex As Integer = 0)
        ...
        ''' </summary>
        <Description("Copies the buffer into the specified byte array starting at the optional startIndex")>
        Public Overloads Sub CopyTo(destinationArray() As Byte, ByVal startIndex As Integer, ByVal length As Integer)
            Dim gh As GCHandle = GCHandle.Alloc(destinationArray, GCHandleType.Pinned)
            Dim gpt = gh.AddrOfPinnedObject + startIndex
        ...
        ''' </summary>
        <Description("Copies the buffer into the specified byte array starting at the optional startIndex")>
        Public Overloads Sub CopyTo(blobStartIndex As Integer, destinationArray() As Byte, ByVal startIndex As Integer, ByVal length As Integer)
            Dim gh As GCHandle = GCHandle.Alloc(destinationArray, GCHandleType.Pinned)
