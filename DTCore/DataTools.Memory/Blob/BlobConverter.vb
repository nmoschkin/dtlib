...
#Region "Exerimental Structure Conversion Functions"
        ...
        Public Shared Function StructureToBlob(ByVal operand As Object, ByRef instance As Blob) As Boolean
        ...
        ''' <remarks></remarks>
        Public Shared Function BlobToStructure(ByVal operand As Blob, ByRef instance As Object, Optional ByVal type As System.Type = Nothing, Optional ByVal COMObjectFullName As String = "") As Boolean
...
#End Region
        ...
        ''' <remarks></remarks>
        Public Shared Function ImageToBytes(ByVal operand As System.Drawing.Image, ByVal fmt As System.Drawing.Imaging.ImageFormat) As Byte()
        ...
        ''' <remarks></remarks>
        Public Shared Function ImageToBytes(ByVal operand As System.Drawing.Image) As Byte()
        ...
        ''' <remarks></remarks>
        Public Shared Function BytesToImage(ByVal operand As Byte()) As System.Drawing.Image
        ...
        Public Shared Function BytesToDate(b() As Byte, Optional ByVal startIndex As Integer = 0) As Date
