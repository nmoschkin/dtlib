...
#Region "Structures"
    ...
    Public Structure OSVERSIONINFOEX
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public ReadOnly Property Processors As Short
            Get
        ...
        Public ReadOnly Property Name As String
            Get
                ...
                If key IsNot Nothing Then
                    Dim s As String = key.GetValue("ProductName")
                    key.Close()
                    Return s
                End If
        ...
        Public Shared Narrowing Operator CType(operand As OSVERSIONINFOEX) As WindowsVersionConstants
            Return (operand.dwMajorVersion << 8) Or operand.dwMinorVersion
        End Operator
...
#Region "System Info Initialization"
    ...
    Public Module SysInfo
        ...
        Sub New()
            ...
            c = (lRet / Marshal.SizeOf(lp))

            ReDim rets(c - 1)

            For i = 0 To c - 1
                rets(i) = Marshal.PtrToStructure(mm.Handle, GetType(SYSTEM_LOGICAL_PROCESSOR_INFORMATION))
        ...
        Friend Function GetOSInfo() As OSVERSIONINFOEX
            ...
            If key IsNot Nothing Then
                ...
                Dim maj As Integer = key.GetValue("CurrentMajorVersionNumber")
                Dim min As Integer = key.GetValue("CurrentMinorVersionNumber")

                Dim build As Integer = key.GetValue("CurrentBuildNumber")
                Dim name As String = key.GetValue("ProductName")
