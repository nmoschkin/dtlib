...
#End Region
 ...
 (<MarshalAs(UnmanagedType.LPWStr)> lpFileName As String,
  ...
  hTemplateFile As IntPtr
    ...
    Alias "MoveFileW" _
    (<MarshalAs(UnmanagedType.LPWStr)> ByVal lpExistingFilename As String,
     <MarshalAs(UnmanagedType.LPWStr)> ByVal lpNewFilename As String
     ) As Integer
    ...
    (<MarshalAs(UnmanagedType.LPWStr)> ByVal lpExistingFilename As String,
     <MarshalAs(UnmanagedType.LPWStr)> ByVal lpNewFilename As String,
     ByVal bFailIfExists As Integer
     ) As Integer
    ...
    (hChangeHandle As IntPtr
        ...
        Public Declare Unicode Function FindFirstFile Lib "kernel32" Alias "FindFirstFileW" (<MarshalAs(UnmanagedType.LPWStr)> ByVal lpFilename As String, <MarshalAs(UnmanagedType.Struct)> ByRef lpFindFileData As WIN32_FIND_DATA) As IntPtr
        Public Declare Unicode Function FindNextFile Lib "kernel32" Alias "FindNextFileW" (ByVal hFindFile As IntPtr, <MarshalAs(UnmanagedType.Struct)> ByRef lpFindFileData As WIN32_FIND_DATA) As <MarshalAs(UnmanagedType.Bool)> Boolean
        Public Declare Unicode Function FindClose Lib "kernel32" (ByVal hFindFile As IntPtr) As Integer
   ...
   lpOverlapped As IntPtr
    ...
    (<MarshalAs(UnmanagedType.LPWStr)> lpszVolumeMountPoint As String,
     ...
     cchBufferLength As UInteger) As <MarshalAs(UnmanagedType.Bool)> Boolean
        ...
        Public Declare Function FileTimeToDosDateTime Lib "kernel32" (ByRef lpFileTime As FILETIME, ByVal lpFatDate As Integer, ByVal lpFatTime As Integer) As Integer
        ...
        Public Declare Unicode Function pGetFileAttributes Lib "kernel32" Alias "GetFileAttributesW" (<MarshalAs(UnmanagedType.LPWStr)> ByVal lpFilename As String) As Integer
        Public Declare Unicode Function pSetFileAttributes Lib "kernel32" Alias "SetFileAttributesW" (<MarshalAs(UnmanagedType.LPWStr)> ByVal lpFilename As String, ByVal dwFileAttributes As Integer) As Integer

        Public Declare Function pGetFileTime Lib "kernel32" Alias "GetFileTime" (ByVal hFile As IntPtr, lpCreationTime As FILETIME, lpLastAccessTime As FILETIME, lpLastWriteTime As FILETIME) As Integer
        Public Declare Function pSetFileTime Lib "kernel32" Alias "SetFileTime" (ByVal hFile As IntPtr, lpCreationTime As FILETIME, lpLastAccessTime As FILETIME, lpLastWriteTime As FILETIME) As Integer

        Public Declare Function pSetFileTime2 Lib "kernel32" Alias "SetFileTime" (ByVal hFile As IntPtr, ByRef lpCreationTime As FILETIME, ByRef lpLastAccessTime As FILETIME, ByRef lpLastWriteTime As FILETIME) As Integer

        Public Declare Function pGetFileSize Lib "kernel32" Alias "GetFileSize" (ByVal hFile As IntPtr, ByRef lpFileSizeHigh As UInteger) As UInteger
        Public Declare Unicode Function pGetFileTitle Lib "comdlg32.dll" Alias "GetFileTitleW" (<MarshalAs(UnmanagedType.LPWStr)> ByVal lpszFile As String, ByVal lpszTitle As String, ByVal cbBuf As Short) As Short
        Public Declare Function pGetFileType Lib "kernel32" Alias "GetFileType" (ByVal hFile As IntPtr) As Integer

        Public Declare Unicode Function GetFileVersionInfo Lib "version.dll" Alias "GetFileVersionInfoW" (<MarshalAs(UnmanagedType.LPWStr)> ByVal lptstrFilename As String, ByVal dwHandle As Integer, ByVal dwLen As Integer, lpData As IntPtr) As Integer
        Public Declare Unicode Function GetFileVersionInfoSize Lib "version.dll" Alias "GetFileVersionInfoSizeW" (<MarshalAs(UnmanagedType.LPWStr)> ByVal lptstrFilename As String, lpdwHandle As Integer) As Integer
    ...
    (<MarshalAs(UnmanagedType.LPWStr)> lpszVolumeName As String,
     ...
     ByRef lpcchReturnLength As UInteger) As <MarshalAs(UnmanagedType.Bool)> Boolean
        ...
        Public Function GetVolumePathNamesForVolumeName(lpszVolumeName As String, ByRef lpszVolumePathNames() As String) As Boolean
            ...
            GetVolumePathNamesForVolumeNameW(lpszVolumeName, 0, 0, ul)

            sp.Alloc((ul + 1) * Len("A"c))
            GetVolumePathNamesForVolumeNameW(lpszVolumeName, sp, sp.Length(), ul)

            lpszVolumePathNames = sp.GrabStringArray(0)
     ...
     pCreateExParams As CREATEFILE2_EXTENDED_PARAMETERS) As IntPtr
        ...
        Public Structure OVERLAPPED
            ...
            Public ReadOnly Property LongOffset As Long
                Get
                    Return MakeLong(Offset, OffsetHigh)
                End Get
            End Property
...
#End Region
        ...
        Public Function LoadBuffer(fileName As String, ByRef buffer As IntPtr) As Long
            ...
            If h Then
                ...
                Dim hi As UInteger
                Dim lo As UInteger = pGetFileSize(h, hi)
        ...
        Public Function LoadBuffer(fileName As String, buffer As IntPtr, len As Long) As Long
            Dim h As IntPtr = CreateFile(fileName, GENERIC_READ, 0, 0, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, FILE_SHARE_READ)
        ...
        Public Function SaveBuffer(fileName As String, buffer As IntPtr, len As Long) As Long
            Dim h As IntPtr = CreateFile(fileName, GENERIC_WRITE, 0, 0, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, 0)
