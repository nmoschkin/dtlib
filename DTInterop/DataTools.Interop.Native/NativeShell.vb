...
#Region "Shell COM Interfaces"
        ...
        Public Interface INativeQueryParserManager
...
#Region "Shell Helper Methods"
        ...
        Public Function SHCreateShellItemArrayFromDataObject(pdo As System.Runtime.InteropServices.ComTypes.IDataObject, ByRef riid As Guid, <MarshalAs(UnmanagedType.[Interface])> ByRef iShellItemArray As IShellItemArray) As Integer
        End Function

        ' The following parameter is not used - binding context.
        <DllImport("shell32.dll", CharSet:=CharSet.Unicode, SetLastError:=True)>
        Public Function SHCreateItemFromParsingName(<MarshalAs(UnmanagedType.LPWStr)> path As String, pbc As IntPtr, ByRef riid As Guid, <MarshalAs(UnmanagedType.[Interface])> ByRef shellItem As IShellItem2) As Integer
        End Function

        ' The following parameter is not used - binding context.
        <DllImport("shell32.dll", CharSet:=CharSet.Unicode, SetLastError:=True)>
        Public Function SHCreateItemFromParsingName(<MarshalAs(UnmanagedType.LPWStr)> path As String, pbc As IntPtr, ByRef riid As Guid, <MarshalAs(UnmanagedType.[Interface])> ByRef shellItem As IShellItem) As Integer
        End Function

        <DllImport("shlwapi.dll", CharSet:=CharSet.Unicode, SetLastError:=True)>
        Public Function PathParseIconLocation(<MarshalAs(UnmanagedType.LPWStr)> ByRef pszIconFile As String) As Integer
        End Function
        ...
        'PCIDLIST_ABSOLUTE
        <DllImport("shell32.dll", CharSet:=CharSet.Unicode, SetLastError:=True)>
        Public Function SHCreateItemFromIDList(pidl As IntPtr, ByRef riid As Guid, <MarshalAs(UnmanagedType.[Interface])> ByRef ppv As IShellItem2) As Integer
        End Function
