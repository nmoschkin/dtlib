...
#End Region
    ...
    Public Class NativeMenuItemCollection
        ...
        Public Function FindById(itemId As UInteger) As NativeMenuItem
        ...
        Public Function OffsetById(itemId As UInteger) As Integer
            Dim subm As NativeMenu,
            ii As NativeMenuItem
        ...
        Public Function Remove(itemId As UInteger) As Boolean
        ...
        Public Function Add(text As String, Optional ByVal data() As Byte = Nothing) As NativeMenuItem
            Dim mii As New MENUITEMINFO
            Return Insert(Count, text, True)
        End Function

        Public Function Add(text As String, bmp As Bitmap, Optional ByVal data() As Byte = Nothing) As NativeMenuItem
            Dim mii As New MENUITEMINFO
            Return Insert(Count, text, bmp, True)
        End Function

        Public Function Add(text As String, icon As Icon, Optional ByVal data() As Byte = Nothing) As NativeMenuItem
            Return Insert(Count, text, icon)
        End Function

        Public Function Insert(insertAfter As Integer, text As String, bmp As Bitmap, ByVal fbyPos As Boolean, Optional ByVal data() As Byte = Nothing) As NativeMenuItem
            Dim mii As New MENUITEMINFO
            Dim mm As MemPtr
        ...
        Public Function Insert(insertAfter As Integer, text As String, ByVal fbyPos As Boolean, Optional ByVal data() As Byte = Nothing) As NativeMenuItem
            Return Insert(insertAfter, text, CType(Nothing, Bitmap), fbyPos, data)
        End Function

        Public Function Insert(insertAfter As Integer, text As String, icon As Icon, Optional ByVal fbyPos As Boolean = True, Optional ByVal data() As Byte = Nothing) As NativeMenuItem
            Return Insert(insertAfter, text, IconToTransparentBitmap(icon), fbyPos, data)
        End Function
...
#End Region
    ...
    Public Class NativeMenuItem
        ...
        Public Property [Default] As Boolean
            ...
            Set(value As Boolean)
                ...
                mii.fState = (mii.fState Or (MFS_DEFAULT And (value)))
        ...
        Public Property Text As String
            Get
                ...
                If GetMenuItemInfo(hMenu, itemId, False, mii) = 0 Then
                    ...
                    FormatMessage(&H1000, 0, err, 0, mm.DangerousGetHandle, 512, 0)
        ...
        Public Property ItemType As MenuItemType
            Get
                ...
                Return (mii.fType And MenuTypeMask)
        ...
        Public Property Enabled As Boolean
            ...
            Set(value As Boolean)
                ...
                mii.fState = (mii.fState Or (MFS_DISABLED And (Not value)))
        ...
        ''' <remarks></remarks>
        Public Sub New(hMenu As IntPtr, itemId As Integer, Optional ByVal byPos As Boolean = True)
    ...
    Public Class NativeMenu
        ...
        Public Sub New(Optional ByVal createHandle As Boolean = True, Optional ByVal isPopup As Boolean = True)
    ...
    Public Module NativeMenuConversion
        ...
        Public Function GetDefaultItem(hMenu As IntPtr, Optional retPos As Boolean = False) As IntPtr
            ...
            For i = 0 To c - 1
                ...
                If (mi.fState And MFS_DEFAULT) Then
                    If retPos Then Return i Else Return mi.wID
                End If
        ...
        Public Function GetMenuItemText(hMenu As IntPtr, ByVal itemId As Integer, Optional ByVal byPos As Boolean = True) As String
            Dim mii As New MENUITEMINFO
            Dim mm As New SafePtr
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function MenuItemCopyToManaged(hMenu As IntPtr, ByVal itemId As Integer, ByRef destItem As ToolStripMenuItem, Optional ByVal byPos As Boolean = True) As Boolean
            ...
            If (mii.fState And MFS_DISABLED) Then
                destItem.Enabled = False
            End If

            If (mii.fState And MFS_DEFAULT) Then
