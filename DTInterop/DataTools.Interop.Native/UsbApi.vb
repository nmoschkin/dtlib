        ...
        Public Function FormatUsbResult(r As USBRESULT) As String
            ...
            For Each fe In fi
                If CInt(fe.GetValue(r)) = r Then
                    ...
                    attr = fe.GetCustomAttribute(GetType(DescriptionAttribute))
...
#End Region
        ...
        Public Structure lpusb_string_descriptor
            ...
            Public ReadOnly Property data As String
                Get
                    If ptr = IntPtr.Zero Then Return 0
                    Return Text.UnicodeEncoding.Unicode.GetString(ptr.GrabBytes(2, bLength))
                End Get
            End Property
        ...
        Public Structure usb_endpoint_descriptor
            ...
            Public ReadOnly Property extra_desc As Byte()
                Get
                    ...
                    extra_desc = mm.GrabBytes(0, extralen)
                End Get
            End Property
        ...
        Public Structure usb_interface_descriptor
            ...
            Public ReadOnly Property endpoint As usb_endpoint_descriptor
                Get
                    endpoint = Marshal.PtrToStructure(ep, GetType(usb_endpoint_descriptor))
                End Get
            End Property
            ...
            Public ReadOnly Property hidDescriptor As usb_hid_descriptor
                Get
                    BytesToStruct(extra_desc, hidDescriptor)
                End Get
            End Property
        ...
        Public Structure usb_interface
            ...
            Public ReadOnly Property altsettings() As usb_interface_descriptor()
                Get
                    ...
                    Dim p As IntPtr = altsetting

                    For i = 0 To num_altsetting - 1

                        alt(i) = Marshal.PtrToStructure(p, GetType(usb_interface_descriptor))
                        p += Marshal.SizeOf(alt(i))
                    Next
                    Return alt
                End Get
            End Property
        ...
        Public Structure usb_config_descriptor
            ...
            Public ReadOnly Property [interface] As usb_interface
                Get
                    [interface] = Marshal.PtrToStructure(iface, GetType(usb_interface))
                End Get
            End Property
        ...
        ''
        Public Function USB_LE16_TO_CPU(x)
            Return x
        End Function
        ...
        Public Structure lpusb_device
            ...
            Public ReadOnly Property [next] As lpusb_device
                Get
                    ...
                    If IntPtr.Size = 4 Then
                        lp.ptr = New IntPtr(ptr.UIntegerAt(0))
                    Else
            ...
            Public ReadOnly Property prev As lpusb_device
                Get
                    ...
                    If IntPtr.Size = 4 Then
                        lp.ptr = New IntPtr(ptr.UIntegerAt(1))
                    Else
            ...
            Public ReadOnly Property filename As String
                Get
                    If ptr = IntPtr.Zero Then Return Nothing
                    filename = ptr.GrabAsciiString(IntPtr.Size * 2)
                End Get
            End Property
            ...
            Public ReadOnly Property bus As lpusb_bus
                Get
                    ...
                    If IntPtr.Size = 4 Then
                        bus.ptr = New IntPtr(BitConverter.ToUInt32(ptr.GrabBytes(bc, IntPtr.Size), 0))
                    Else
                        bus.ptr = New IntPtr(BitConverter.ToInt64(ptr.GrabBytes(bc, IntPtr.Size), 0))
                    End If
                End Get
            End Property
            ...
            Public ReadOnly Property descriptor As usb_device_descriptor
                Get
                    ...
                    descriptor = Marshal.PtrToStructure(IntPtr.Add(ptr, bc), GetType(usb_device_descriptor))
                End Get
            End Property
            ...
            Public ReadOnly Property config As usb_config_descriptor
                Get
                    If ptr = IntPtr.Zero Then Return Nothing
                    Dim bc As Integer = LIBUSB_PATH_MAX + (IntPtr.Size * 3) + Marshal.SizeOf(New usb_device_descriptor)
                    Dim str As New DataTools.Memory.MemPtr

                    If IntPtr.Size = 4 Then
                        str.Handle = New IntPtr(BitConverter.ToUInt32(ptr.GrabBytes(bc, IntPtr.Size), 0))
                    Else
                        str.Handle = New IntPtr(BitConverter.ToInt64(ptr.GrabBytes(bc, IntPtr.Size), 0))
                    End If
            ...
            Public ReadOnly Property dev As IntPtr
                Get
                    If ptr = IntPtr.Zero Then Return Nothing
                    Dim bc As Integer = LIBUSB_PATH_MAX + (IntPtr.Size * 4) + Marshal.SizeOf(New usb_device_descriptor)
                    If IntPtr.Size = 4 Then
                        dev = New IntPtr(BitConverter.ToUInt32(ptr.GrabBytes(bc, IntPtr.Size), 0))
                    Else
                        dev = New IntPtr(BitConverter.ToInt64(ptr.GrabBytes(bc, IntPtr.Size), 0))
                    End If
                End Get
            End Property
            ...
            Public ReadOnly Property devnum As Byte
                Get
                    If ptr = IntPtr.Zero Then Return Nothing
                    Dim bc As Integer = LIBUSB_PATH_MAX + (IntPtr.Size * 5) + Marshal.SizeOf(New usb_device_descriptor)
            ...
            Public ReadOnly Property num_children As Byte
                Get
                    If ptr = IntPtr.Zero Then Return Nothing
                    Dim bc As Integer = LIBUSB_PATH_MAX + (IntPtr.Size * 5) + 1 + Marshal.SizeOf(New usb_device_descriptor)
                    Return ptr.ByteAt(bc)
                End Get
            End Property
            ...
            Public ReadOnly Property children As lpusb_device
                Get
                    If ptr = IntPtr.Zero Then Return Nothing
                    Dim lp As New lpusb_device
                    Dim bc As Integer = LIBUSB_PATH_MAX + (IntPtr.Size * 5) + 2 + Marshal.SizeOf(New usb_device_descriptor)
                    Dim mm As MemPtr

                    If IntPtr.Size = 4 Then
                        mm = New IntPtr(BitConverter.ToUInt32(ptr.GrabBytes(bc, IntPtr.Size), 0))
                        If mm = IntPtr.Zero Then Return Nothing

                        lp.ptr = New IntPtr(mm.UIntegerAt(0))
                    Else
                        mm = New IntPtr(BitConverter.ToInt64(ptr.GrabBytes(bc, IntPtr.Size), 0))
                        If mm = IntPtr.Zero Then Return Nothing
        ...
        Public Structure lpusb_bus
            ...
            Public ReadOnly Property devices As lpusb_device
                Get
                    ...
                    If IntPtr.Size = 4 Then
                        lp.ptr = New IntPtr(BitConverter.ToUInt32(ptr.GrabBytes(bc, IntPtr.Size), 0))
                    Else
                        lp.ptr = New IntPtr(BitConverter.ToInt64(ptr.GrabBytes(bc, IntPtr.Size), 0))
                    End If
            ...
            Public ReadOnly Property location As UInteger
                Get
                    ...
                    Dim lp As UInteger
                    Dim bc As Integer = LIBUSB_PATH_MAX + (IntPtr.Size * 3)
                    lp = (BitConverter.ToUInt32(ptr.GrabBytes(bc, IntPtr.Size), 0))
                    Return lp
                End Get
            End Property
