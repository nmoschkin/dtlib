...
#Region "System and File System"
        ...
        ''' <remarks></remarks>
        Public Function DeleteWithExtremePrejudice(ByVal directory As String, Optional preserveRoot As Boolean = True, Optional warnConfirm As Boolean = True) As Boolean
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function IsExt(fileName As String, ByVal ext As String) As Boolean
        ...
        ''' </remarks>
        Public Function BrowseCallback(ByVal hWnd As IntPtr, ByVal uMsg As Short, ByVal wParam As Integer, ByVal lParam As Integer) As Integer
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetFileAttributes(ByVal FileName As String) As FileAttributes
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function SetFileAttributes(ByVal FileName As String, ByVal Attributes As FileAttributes) As Boolean
        ...
        ''' <remarks></remarks>
        Public Sub GetFileTime(ByVal FileName As String, ByRef CreationTime As Date, ByRef LastAccessTime As Date, ByRef LastWriteTime As Date)
            Dim wf As New WIN32_FIND_DATA
            Dim i As IntPtr
        ...
        ''' <param name="LastWriteTime"></param>
        ''' <remarks></remarks>
        Public Sub SetFileTime(ByVal FileName As String, ByVal CreationTime As FILETIME, ByVal LastAccessTime As FILETIME, ByVal LastWriteTime As FILETIME)

            Dim hFile As Integer

            If Directory.Exists(FileName) Then
                hFile = CreateFile(FileName, FILE_WRITE_ATTRIBUTES, 0&, 0, OPEN_EXISTING, FILE_FLAG_BACKUP_SEMANTICS, 0&)
            ElseIf File.Exists(FileName) Then
                hFile = CreateFile(FileName, FILE_WRITE_ATTRIBUTES, 0&, 0, OPEN_EXISTING, 0&, 0&)
            Else
                Return
            End If
        ...
        ''' <param name="LastWriteTime"></param>
        ''' <remarks></remarks>
        Public Sub SetFileTime(ByVal FileName As String, ByVal CreationTime As Date, ByVal LastAccessTime As Date, ByVal LastWriteTime As Date)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetFileSize(ByVal FileName As String, ByRef lpSizeHigh As UInteger) As UInteger
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetSpecialFolder(ByVal hWnd As IntPtr, ByVal fSpcPath As SpecialFolderConstants) As String
            Dim lpStr As String
