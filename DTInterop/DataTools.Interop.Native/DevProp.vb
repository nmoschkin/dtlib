...
#Region "SetupApi"
        ...
        Public Declare Function SetupDiGetDeviceInterfaceDetail Lib "setupapi.dll" _
    Alias "SetupDiGetDeviceInterfaceDetailW" _
        (<[In]> ByVal DeviceInfoSet As IntPtr,
         <[In], MarshalAs(UnmanagedType.Struct)>
         ByRef beviceInterfaceData As SP_DEVICE_INTERFACE_DATA,
         <Out, [In]> ByVal DeviceInterfaceDetailData As IntPtr,
         <[In]> ByVal DeviceInterfaceDetailDataSize As UInteger,
...
#End Region
        ...
        Private Function GetKeyName(dpk As DEVPROPKEY) As String
            ...
            For Each fe In fi
                ...
                g = fe.GetValue(Nothing)

                If g = dpk Then
                    '' we found it!
                    Dim strs() As String = BatchParse(fe.Name, "_")

                    Dim s As String = SeparateCamel(strs(1)) & " Property: " & vbCrLf & SeparateCamel(strs(2))
                    Return s
                End If
        ...
        Public Function EnumListParse(Of T)(values As String) As T()
            ...
            Dim vs() As String = BatchParse(values, ",")
