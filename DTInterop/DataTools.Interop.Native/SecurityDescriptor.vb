...
Namespace Native
    ...
    Module SecurityDescriptor
        ...
        Public Function SECURITY_DESCRIPTOR_MIN_LENGTH() As Integer
            SECURITY_DESCRIPTOR_MIN_LENGTH = Marshal.SizeOf(New SECURITY_DESCRIPTOR)
        End Function
        ...
        Public Function SecurityDescriptorToReal(sd As SECURITY_DESCRIPTOR) As SECURITY_DESCRIPTOR_REAL
            ...
            sr.Sacl = Marshal.PtrToStructure(sd.Sacl, GetType(ACL))
            sr.Dacl = Marshal.PtrToStructure(sd.Dacl, GetType(ACL))
