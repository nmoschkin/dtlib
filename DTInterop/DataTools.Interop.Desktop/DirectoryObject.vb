    ...
    Public Class DirectoryObject
        ...
        Public Sub New(parsingName As String, Optional isSpecial As Boolean = False, Optional initialize As Boolean = True, Optional iconSize As StandardIcons = StandardIcons.Icon48)
            ...
            If (_IsSpecial) Then
                ...
                If (res = HResult.Ok) Then
                    ...
                    CanonicalName = mm
                    If (Me.ParsingName Is Nothing) Then Me.ParsingName = mm
            ...
            Else
                ...
                CanonicalName = parsingName = _Path
            End If
        ...
        Public Sub Refresh(Optional iconSize As StandardIcons? = Nothing) Implements ISimpleShellItem.Refresh
            ...
            If (res = HResult.Ok) Then
                ...
                shitem.BindToHandler(IntPtr.Zero, Guid.Parse(ShellBHIDGuid.ShellFolderObject), Guid.Parse(ShellIIDGuid.IShellFolder2), shfld)

                _SysInterface = shfld
                shfld.EnumObjects(0, &H50F0, enumer)
                ...
                If (enumer IsNot Nothing) Then
                    ...
                    Do
                        ...
                        If (IntPtr.Size = 4) Then
                            inv = CType(mm2.IntegerAt(1), IntPtr)
                        Else
                        ...
                        If (inv._ptr <> 0) Then
                            ...
                            If (inv.CharAt(0) <> Chr(0)) Then
                                ...
                                Dim drat As FileAttributes = lpInfo.dwAttributes
