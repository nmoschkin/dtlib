...
Namespace Disk
    ...
    Public Class VirtualDisk
        ...
        Public Overrides Function ToString() As String
            ...
            ToString = PrintFriendlySize(Size) & " Virtual Drive [" & If(Attached, "Attached", "Not Attached") & "]"
        ...
        Public ReadOnly Property PhysicalSize As Long
            Get
                ...
                iSize = Marshal.SizeOf(info)
                StructToBytes(info, mm)

                Dim r As UInteger =
                GetVirtualDiskInformation(_Handle, iSize, mm, sizeUSed)

                BytesToStruct(mm, info)
        ...
        Public Shared Function Create(imageFile As String,
                                    ...
                                    Optional ByVal blockSize As Integer = 2097152,
                                    Optional ByVal sectorSize As Integer = 512,
            ...
            Select Case ext
                ...
                Case ".vhd"
                    ...
                    r = CreateVirtualDisk(vst,
                                      ...
                                      IntPtr.Zero,
                                      CREATE_VIRTUAL_DISK_FLAGS.CREATE_VIRTUAL_DISK_FLAG_FULL_PHYSICAL_ALLOCATION And fixedSize,
                                      0,
                                      cp1,
                                      IntPtr.Zero,
                                      handleNew)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function Open(ByVal openReadOnly As Boolean) As Boolean
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function Open(imageFile As String)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function Open(imageFile As String, ByVal openReadOnly As Boolean) As Boolean

            Dim ext As String = Path.GetExtension(imageFile).ToLower
            Dim vst As VIRTUAL_STORAGE_TYPE
            If _Handle <> 0 Then Close()
            Dim h As Long = 0
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function Attach(ByVal makePermanent As Boolean) As Boolean
            If _Handle = 0 OrElse Attached Then Return False
            Dim sdsize As UInteger = 0
            Dim mm As New MemPtr(8)

            mm.ByteAt(0) = 1
            Dim r As UInteger = AttachVirtualDisk(_Handle, IntPtr.Zero, makePermanent And ATTACH_VIRTUAL_DISK_FLAG.ATTACH_VIRTUAL_DISK_FLAG_PERMANENT_LIFETIME, IntPtr.Zero, mm.Handle, IntPtr.Zero)
            mm.Free()
            Attach = r = 0
        ...
        Public Function Close() As Boolean
            ...
            Dim r As UInteger = CloseHandle(_Handle)
            Close = r <> 0
            If Close Then _Handle = IntPtr.Zero
        End Function
        ...
        ''' <remarks></remarks>
        Public Sub New(imageFile As String, ByVal openDisk As Boolean)
        ...
        ''' <remarks></remarks>
        Public Sub New(imageFile As String, ByVal openDisk As Boolean, ByVal openReadOnly As Boolean)
            _ImageFile = imageFile
