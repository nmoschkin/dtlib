    ...
    Public Structure FILE_NOTIFY_INFORMATION
        ...
        Public Property NextEntryOffset As Integer
            Get
                ...
                Return ptr.IntegerAt(0)
            End Get
            Set(value As Integer)
                If ptr = IntPtr.Zero Then Return
                ptr.IntegerAt(0) = value
            End Set
        End Property
        ...
        Public ReadOnly Property Action As FileActions
            Get
                If ptr = IntPtr.Zero Then Return 0
                Return CType(ptr.IntegerAt(1), FileActions)
            End Get
        End Property
        ...
        Public ReadOnly Property Filename As String
            Get
                ...
                Return Text.Encoding.Unicode.GetString(ptr.GrabBytes(CType(12, IntPtr), FilenameLength))
            End Get
        End Property
...
#Region "Internal Methods"
        ...
        Protected Function internalWatch() As Boolean
            ...
            Dim bufflen As Integer = CInt(_Buff.Length)
