...
#Region "Address Structures"
        ...
        Public Structure LPIP_ADAPTER_DNS_SUFFIX
            ...
            Public Function ToStruct() As IP_ADAPTER_DNS_SUFFIX
                If Handle = IntPtr.Zero Then Return Nothing
                ToStruct = Marshal.PtrToStructure(Handle.Handle, GetType(IP_ADAPTER_DNS_SUFFIX))
            End Function
        ...
        Public Structure LPIP_ADAPTER_PREFIX
            ...
            Public Function ToAddress() As IP_ADAPTER_PREFIX
                If Handle = IntPtr.Zero Then Return Nothing
                ToAddress = Marshal.PtrToStructure(Handle.Handle, GetType(IP_ADAPTER_PREFIX))
            End Function
        ...
        Public Structure LPADAPTER_UNICAST_ADDRESS
            ...
            Public Function ToAddress() As ADAPTER_UNICAST_ADDRESS
                If Handle = IntPtr.Zero Then Return Nothing
                ToAddress = Marshal.PtrToStructure(Handle.Handle, GetType(ADAPTER_UNICAST_ADDRESS))
            End Function
        ...
        Public Structure LPADAPTER_MULTICAST_ADDRESS
            ...
            Public Function ToAddress() As ADAPTER_MULTICAST_ADDRESS
                If Handle = IntPtr.Zero Then Return Nothing
                ToAddress = Marshal.PtrToStructure(Handle.Handle, GetType(ADAPTER_MULTICAST_ADDRESS))
            End Function
...
#End Region
        ...
        Public Structure LPIP_ADAPTER_ADDRESSES
            ...
            Public Function ToAdapterStruct() As IP_ADAPTER_ADDRESSES
                If Handle = IntPtr.Zero Then Return Nothing
                ToAdapterStruct = Marshal.PtrToStructure(Handle.Handle, GetType(IP_ADAPTER_ADDRESSES))
            End Function
            ...
            Public Shared Widening Operator CType(operand As LPIP_ADAPTER_ADDRESSES) As IP_ADAPTER_ADDRESSES
                Dim a As IP_ADAPTER_ADDRESSES = Marshal.PtrToStructure(operand.Handle.Handle, GetType(IP_ADAPTER_ADDRESSES))
                Return a
            End Operator
...
#Region "Functions"
        ...
        Function GetAdapters(Optional ByRef origPtr As MemPtr = Nothing, Optional ByVal noRelease As Boolean = True) As IP_ADAPTER_ADDRESSES()
            ...
            Do
                If (adapt.Description = "") Or (adapt.FirstDnsServerAddress.Handle = 0L) Then
                    c += 1
                    adapt = adapt.Next
