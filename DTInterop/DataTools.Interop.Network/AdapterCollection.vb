...
Namespace Network
    ...
    Public Module AdapterWrap
        ...
        '' For most usages, the AdaptersCollection object should be used.
        '' The NetworkAdapters collection is also a viable option
        '' and possibly of a lighter variety.

        '' Read notes, further below, for more detailed information about the implementation
        '' of these wrappers and their nature.
        ...
        Public NotInheritable Class NetworkAdapter
            ...
            Friend Sub New(nativeObject As IP_ADAPTER_ADDRESSES)
                ...
                If mm.Handle <> IntPtr.Zero Then
                    '' Get a WPFImage 
                    _Icon = MakeWPFImage(GetItemIcon(mm, SHIL_EXTRALARGE))
                    mm.Free()
            ...
            ''' <summary>
            ''' Is true if the device dialog cam be displayed for this adapter.
            ''' </summary>
            ''' <value></value>
            ''' <returns></returns>
            ''' <remarks></remarks>
            ...
            ''' <summary>
            ''' Is true if this device can display the network dialogs.
            ''' </summary>
            ''' <value></value>
            ''' <returns></returns>
            ''' <remarks></remarks>
