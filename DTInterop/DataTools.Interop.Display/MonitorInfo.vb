...
Namespace Display
    ...
    Public Class Monitors
        ...
        Private Function _enum(hMonitor As IntPtr, hdcMonitor As IntPtr, ByRef lpRect As RECT, lParamIn As IntPtr) As <MarshalAs(UnmanagedType.Bool)> Boolean
            Dim lParam As Memory.MemPtr = lParamIn

            Me.Add(New MonitorInfo(hMonitor, lParam.IntegerAt(0)))
            lParam.IntegerAt(0) += 1
        ...
        Public Function Refresh() As Boolean
            ...
            Dim mm As New Memory.MemPtr(IntPtr.Size)
            mm.IntegerAt(0) = 1

            Dim i As Integer = mm.IntegerAt(0)
            Refresh = EnumDisplayMonitors(0, 0, AddressOf _enum, mm._ptr)
